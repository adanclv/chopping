...
export default function TablaCategorias({ categorias }) {
    ...
    const handleEdit = (id) => {
        navigate(`/admin/categorias/edit/${id}`);
    };
    ...
    return (
        <div className="container-table-admin">
            <div className="tabla-5col header-tabla">
                <p>Id</p>
                <p>Nombre</p>
                <p>Descripcion</p>
                <p>Estado</p>
            ...
            {categorias && categorias.map(categoria => (
                <div className="tabla-5col content-tabla" key={categoria.NoCategoria}>
                    <p>{categoria.NoCategoria}</p>
                    <p>{categoria.NombCategoria}</p>
                    <p>{description(categoria.DescCategoria)}</p>
                    <p className={'estado ' + (categoria.Estado === 'activo' ? 'activo' : 'inactivo')}></p>
                    <div className="btn-action">
                        <button onClick={() => handleEdit(categoria.NoCategoria)}>
